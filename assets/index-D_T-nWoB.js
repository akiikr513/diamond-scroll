 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var R0;function tM(){if(R0)return ht;R0=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),a=Symbol.for("react.strict_mode"),r=Symbol.for("react.profiler"),l=Symbol.for("react.consumer"),u=Symbol.for("react.context"),f=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),h=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),_=Symbol.iterator;function v(L){return L===null||typeof L!="object"?null:(L=_&&L[_]||L["@@iterator"],typeof L=="function"?L:null)}var x={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},M=Object.assign,T={};function S(L,J,he){this.props=L,this.context=J,this.refs=T,this.updater=he||x}S.prototype.isReactComponent={},S.prototype.setState=function(L,J){if(typeof L!="object"&&typeof L!="function"&&L!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,L,J,"setState")},S.prototype.forceUpdate=function(L){this.updater.enqueueForceUpdate(this,L,"forceUpdate")};function y(){}y.prototype=S.prototype;function N(L,J,he){this.props=L,this.context=J,this.refs=T,this.updater=he||x}var U=N.prototype=new y;U.constructor=N,M(U,S.prototype),U.isPureReactComponent=!0;var D=Array.isArray,O={H:null,A:null,T:null,S:null,V:null},z=Object.prototype.hasOwnProperty;function B(L,J,he,ge,Ae,Be){return he=Be.ref,{$$typeof:o,type:L,key:J,ref:he!==void 0?he:null,props:Be}}function V(L,J){return B(L.type,J,void 0,void 0,void 0,L.props)}function C(L){return typeof L=="object"&&L!==null&&L.$$typeof===o}function w(L){var J={"=":"=0",":":"=2"};return"$"+L.replace(/[=:]/g,function(he){return J[he]})}var H=/\/+/g;function Y(L,J){return typeof L=="object"&&L!==null&&L.key!=null?w(""+L.key):J.toString(36)}function ae(){}function re(L){switch(L.status){case"fulfilled":return L.value;case"rejected":throw L.reason;default:switch(typeof L.status=="string"?L.then(ae,ae):(L.status="pending",L.then(function(J){L.status==="pending"&&(L.status="fulfilled",L.value=J)},function(J){L.status==="pending"&&(L.status="rejected",L.reason=J)})),L.status){case"fulfilled":return L.value;case"rejected":throw L.reason}}throw L}function ie(L,J,he,ge,Ae){var Be=typeof L;(Be==="undefined"||Be==="boolean")&&(L=null);var ee=!1;if(L===null)ee=!0;else switch(Be){case"bigint":case"string":case"number":ee=!0;break;case"object":switch(L.$$typeof){case o:case e:ee=!0;break;case g:return ee=L._init,ie(ee(L._payload),J,he,ge,Ae)}}if(ee)return Ae=Ae(L),ee=ge===""?"."+Y(L,0):ge,D(Ae)?(he="",ee!=null&&(he=ee.replace(H,"$&/")+"/"),ie(Ae,J,he,"",function(Ye){return Ye})):Ae!=null&&(C(Ae)&&(Ae=V(Ae,he+(Ae.key==null||L&&L.key===Ae.key?"":(""+Ae.key).replace(H,"$&/")+"/")+ee)),J.push(Ae)),1;ee=0;var pe=ge===""?".":ge+":";if(D(L))for(var Te=0;Te<L.length;Te++)ge=L[Te],Be=pe+Y(ge,Te),ee+=ie(ge,J,he,Be,Ae);else if(Te=v(L),typeof Te=="function")for(L=Te.call(L),Te=0;!(ge=L.next()).done;)ge=ge.value,Be=pe+Y(ge,Te++),ee+=ie(ge,J,he,Be,Ae);else if(Be==="object"){if(typeof L.then=="function")return ie(re(L),J,he,ge,Ae);throw J=String(L),Error("Objects are not valid as a React child (found: "+(J==="[object Object]"?"object with keys {"+Object.keys(L).join(", ")+"}":J)+"). If you meant to render a collection of children, use an array instead.")}return ee}function P(L,J,he){if(L==null)return L;var ge=[],Ae=0;return ie(L,ge,"","",function(Be){return J.call(he,Be,Ae++)}),ge}function K(L){if(L._status===-1){var J=L._result;J=J(),J.then(function(he){(L._status===0||L._status===-1)&&(L._status=1,L._result=he)},function(he){(L._status===0||L._status===-1)&&(L._status=2,L._result=he)}),L._status===-1&&(L._status=0,L._result=J)}if(L._status===1)return L._result.default;throw L._result}var q=typeof reportError=="function"?reportError:function(L){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var J=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof L=="object"&&L!==null&&typeof L.message=="string"?String(L.message):String(L),error:L});if(!window.dispatchEvent(J))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",L);return}console.error(L)};function ye(){}return ht.Children={map:P,forEach:function(L,J,he){P(L,function(){J.apply(this,arguments)},he)},count:function(L){var J=0;return P(L,function(){J++}),J},toArray:function(L){return P(L,function(J){return J})||[]},only:function(L){if(!C(L))throw Error("React.Children.only expected to receive a single React element child.");return L}},ht.Component=S,ht.Fragment=n,ht.Profiler=r,ht.PureComponent=N,ht.StrictMode=a,ht.Suspense=p,ht.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=O,ht.__COMPILER_RUNTIME={__proto__:null,c:function(L){return O.H.useMemoCache(L)}},ht.cache=function(L){return function(){return L.apply(null,arguments)}},ht.cloneElement=function(L,J,he){if(L==null)throw Error("The argument must be a React element, but you passed "+L+".");var ge=M({},L.props),Ae=L.key,Be=void 0;if(J!=null)for(ee in J.ref!==void 0&&(Be=void 0),J.key!==void 0&&(Ae=""+J.key),J)!z.call(J,ee)||ee==="key"||ee==="__self"||ee==="__source"||ee==="ref"&&J.ref===void 0||(ge[ee]=J[ee]);var ee=arguments.length-2;if(ee===1)ge.children=he;else if(1<ee){for(var pe=Array(ee),Te=0;Te<ee;Te++)pe[Te]=arguments[Te+2];ge.children=pe}return B(L.type,Ae,void 0,void 0,Be,ge)},ht.createContext=function(L){return L={$$typeof:u,_currentValue:L,_currentValue2:L,_threadCount:0,Provider:null,Consumer:null},L.Provider=L,L.Consumer={$$typeof:l,_context:L},L},ht.createElement=function(L,J,he){var ge,Ae={},Be=null;if(J!=null)for(ge in J.key!==void 0&&(Be=""+J.key),J)z.call(J,ge)&&ge!=="key"&&ge!=="__self"&&ge!=="__source"&&(Ae[ge]=J[ge]);var ee=arguments.length-2;if(ee===1)Ae.children=he;else if(1<ee){for(var pe=Array(ee),Te=0;Te<ee;Te++)pe[Te]=arguments[Te+2];Ae.children=pe}if(L&&L.defaultProps)for(ge in ee=L.defaultProps,ee)Ae[ge]===void 0&&(Ae[ge]=ee[ge]);return B(L,Be,void 0,void 0,null,Ae)},ht.createRef=function(){return{current:null}},ht.forwardRef=function(L){return{$$typeof:f,render:L}},ht.isValidElement=C,ht.lazy=function(L){return{$$typeof:g,_payload:{_status:-1,_result:L},_init:K}},ht.memo=function(L,J){return{$$typeof:h,type:L,compare:J===void 0?null:J}},ht.startTransition=function(L){var J=O.T,he={};O.T=he;try{var ge=L(),Ae=O.S;Ae!==null&&Ae(he,ge),typeof ge=="object"&&ge!==null&&typeof ge.then=="function"&&ge.then(ye,q)}catch(Be){q(Be)}finally{O.T=J}},ht.unstable_useCacheRefresh=function(){return O.H.useCacheRefresh()},ht.use=function(L){return O.H.use(L)},ht.useActionState=function(L,J,he){return O.H.useActionState(L,J,he)},ht.useCallback=function(L,J){return O.H.useCallback(L,J)},ht.useContext=function(L){return O.H.useContext(L)},ht.useDebugValue=function(){},ht.useDeferredValue=function(L,J){return O.H.useDeferredValue(L,J)},ht.useEffect=function(L,J,he){var ge=O.H;if(typeof he=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return ge.useEffect(L,J)},ht.useId=function(){return O.H.useId()},ht.useImperativeHandle=function(L,J,he){return O.H.useImperativeHandle(L,J,he)},ht.useInsertionEffect=function(L,J){return O.H.useInsertionEffect(L,J)},ht.useLayoutEffect=function(L,J){return O.H.useLayoutEffect(L,J)},ht.useMemo=function(L,J){return O.H.useMemo(L,J)},ht.useOptimistic=function(L,J){return O.H.useOptimistic(L,J)},ht.useReducer=function(L,J,he){return O.H.useReducer(L,J,he)},ht.useRef=function(L){return O.H.useRef(L)},ht.useState=function(L){return O.H.useState(L)},ht.useSyncExternalStore=function(L,J,he){return O.H.useSyncExternalStore(L,J,he)},ht.useTransition=function(){return O.H.useTransition()},ht.version="19.1.1",ht}var w0;function bp(){return w0||(w0=1,Hh.exports=tM()),Hh.exports}var ln=bp(),Vh={exports:{}},nl={},Gh={exports:{}},kh={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var C0;function nM(){return C0||(C0=1,(function(o){function e(P,K){var q=P.length;P.push(K);e:for(;0<q;){var ye=q-1>>>1,L=P[ye];if(0<r(L,K))P[ye]=K,P[q]=L,q=ye;else break e}}function n(P){return P.length===0?null:P[0]}function a(P){if(P.length===0)return null;var K=P[0],q=P.pop();if(q!==K){P[0]=q;e:for(var ye=0,L=P.length,J=L>>>1;ye<J;){var he=2*(ye+1)-1,ge=P[he],Ae=he+1,Be=P[Ae];if(0>r(ge,q))Ae<L&&0>r(Be,ge)?(P[ye]=Be,P[Ae]=q,ye=Ae):(P[ye]=ge,P[he]=q,ye=he);else if(Ae<L&&0>r(Be,q))P[ye]=Be,P[Ae]=q,ye=Ae;else break e}}return K}function r(P,K){var q=P.sortIndex-K.sortIndex;return q!==0?q:P.id-K.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var l=performance;o.unstable_now=function(){return l.now()}}else{var u=Date,f=u.now();o.unstable_now=function(){return u.now()-f}}var p=[],h=[],g=1,_=null,v=3,x=!1,M=!1,T=!1,S=!1,y=typeof setTimeout=="function"?setTimeout:null,N=typeof clearTimeout=="function"?clearTimeout:null,U=typeof setImmediate<"u"?setImmediate:null;function D(P){for(var K=n(h);K!==null;){if(K.callback===null)a(h);else if(K.startTime<=P)a(h),K.sortIndex=K.expirationTime,e(p,K);else break;K=n(h)}}function O(P){if(T=!1,D(P),!M)if(n(p)!==null)M=!0,z||(z=!0,Y());else{var K=n(h);K!==null&&ie(O,K.startTime-P)}}var z=!1,B=-1,V=5,C=-1;function w(){return S?!0:!(o.unstable_now()-C<V)}function H(){if(S=!1,z){var P=o.unstable_now();C=P;var K=!0;try{e:{M=!1,T&&(T=!1,N(B),B=-1),x=!0;var q=v;try{t:{for(D(P),_=n(p);_!==null&&!(_.expirationTime>P&&w());){var ye=_.callback;if(typeof ye=="function"){_.callback=null,v=_.priorityLevel;var L=ye(_.expirationTime<=P);if(P=o.unstable_now(),typeof L=="function"){_.callback=L,D(P),K=!0;break t}_===n(p)&&a(p),D(P)}else a(p);_=n(p)}if(_!==null)K=!0;else{var J=n(h);J!==null&&ie(O,J.startTime-P),K=!1}}break e}finally{_=null,v=q,x=!1}K=void 0}}finally{K?Y():z=!1}}}var Y;if(typeof U=="function")Y=function(){U(H)};else if(typeof MessageChannel<"u"){var ae=new MessageChannel,re=ae.port2;ae.port1.onmessage=H,Y=function(){re.postMessage(null)}}else Y=function(){y(H,0)};function ie(P,K){B=y(function(){P(o.unstable_now())},K)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(P){P.callback=null},o.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):V=0<P?Math.floor(1e3/P):5},o.unstable_getCurrentPriorityLevel=function(){return v},o.unstable_next=function(P){switch(v){case 1:case 2:case 3:var K=3;break;default:K=v}var q=v;v=K;try{return P()}finally{v=q}},o.unstable_requestPaint=function(){S=!0},o.unstable_runWithPriority=function(P,K){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var q=v;v=P;try{return K()}finally{v=q}},o.unstable_scheduleCallback=function(P,K,q){var ye=o.unstable_now();switch(typeof q=="object"&&q!==null?(q=q.delay,q=typeof q=="number"&&0<q?ye+q:ye):q=ye,P){case 1:var L=-1;break;case 2:L=250;break;case 5:L=1073741823;break;case 4:L=1e4;break;default:L=5e3}return L=q+L,P={id:g++,callback:K,priorityLevel:P,startTime:q,expirationTime:L,sortIndex:-1},q>ye?(P.sortIndex=q,e(h,P),n(p)===null&&P===n(h)&&(T?(N(B),B=-1):T=!0,ie(O,q-ye))):(P.sortIndex=L,e(p,P),M||x||(M=!0,z||(z=!0,Y()))),P},o.unstable_shouldYield=w,o.unstable_wrapCallback=function(P){var K=v;return function(){var q=v;v=K;try{return P.apply(this,arguments)}finally{v=q}}}})(kh)),kh}var D0;function iM(){return D0||(D0=1,Gh.exports=nM()),Gh.exports}var Xh={exports:{}},zn={};/**
 * @license React
...
`)+`
`+y);const U=N+S+u,D=N+y+f,O=Gv(r,r.VERTEX_SHADER,U),z=Gv(r,r.FRAGMENT_SHADER,D);r.attachShader(T,O),r.attachShader(T,z),n.index0AttributeName!==void 0?r.bindAttribLocation(T,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(T,0,"position"),r.linkProgram(T);function B(H){if(o.debug.checkShaderErrors){const Y=r.getProgramInfoLog(T)||"",ae=r.getShaderInfoLog(O)||"",re=r.getShaderInfoLog(z)||"",ie=Y.trim(),P=ae.trim(),K=re.trim();let q=!0,ye=!0;if(r.getProgramParameter(T,r.LINK_STATUS)===!1)if(q=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(r,T,O,z);else{const L=Xv(r,O,"vertex"),J=Xv(r,z,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(T,r.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};class Yw extends pT{constructor(e){super(e),this.type=ba}parse(e){const u=function(V,C){switch(V){case 1:throw new Error("THREE.HDRLoader: Read Error: "+(C||""));case 2:throw new Error("THREE.HDRLoader: Write Error: "+(C||""));case 3:throw new Error("THREE.HDRLoader: Bad File Format: "+(C||""));default:case 4:throw new Error("THREE.HDRLoader: Memory Error: "+(C||""))}},_=function(V,C,w){C=C||1024;let Y=V.pos,ae=-1,re=0,ie="",P=String.fromCharCode.apply(null,new Uint16Array(V.subarray(Y,Y+128)));for(;0>(ae=P.indexOf(`
`))&&re<C&&Y<V.byteLength;)ie+=P,re+=P.length,Y+=128,P+=String.fromCharCode.apply(null,new Uint16Array(V.subarray(Y,Y+128)));return-1<ae?(V.pos+=re+ae+1,ie+P.slice(0,ae)):!1},v=function(V){const C=/^#\?(\S+)/,w=/^\s*GAMMA\s*=\s*(\d+(\.\d+)?)\s*$/,H=/^\s*EXPOSURE\s*=\s*(\d+(\.\d+)?)\s*$/,Y=/^\s*FORMAT=(\S+)\s*$/,ae=/^\s*\-Y\s+(\d+)\s+\+X\s+(\d+)\s*$/,re={valid:0,string:"",comments:"",programtype:"RGBE",format:"",gamma:1,exposure:1,width:0,height:0};let ie,P;for((V.pos>=V.byteLength||!(ie=_(V)))&&u(1,"no header found"),(P=ie.match(C))||u(3,"bad initial token"),re.valid|=1,re.programtype=P[1],re.string+=ie+`
`;ie=_(V),ie!==!1;){if(re.string+=ie+`
`,ie.charAt(0)==="#"){re.comments+=ie+`
`;continue}if((P=ie.match(w))&&(re.gamma=parseFloat(P[1])),(P=ie.match(H))&&(re.exposure=parseFloat(P[1])),(P=ie.match(Y))&&(re.valid|=2,re.format=P[1]),(P=ie.match(ae))&&(re.valid|=4,re.height=parseInt(P[1],10),re.width=parseInt(P[2],10)),re.valid&2&&re.valid&4)break}return re.valid&2||u(3,"missing format specifier"),re.valid&4||u(3,"missing image size specifier"),re},x=function(V,C,w){const H=C;if(H<8||H>32767||V[0]!==2||V[1]!==2||V[2]&128)return new Uint8Array(V);H!==(V[2]<<8|V[3])&&u(3,"wrong scanline width");const Y=new Uint8Array(4*C*w);Y.length||u(4,"unable to allocate buffer space");let ae=0,re=0;const ie=4*H,P=new Uint8Array(4),K=new Uint8Array(ie);let q=w;for(;q>0&&re<V.byteLength;){re+4>V.byteLength&&u(1),P[0]=V[re++],P[1]=V[re++],P[2]=V[re++],P[3]=V[re++],(P[0]!=2||P[1]!=2||(P[2]<<8|P[3])!=H)&&u(3,"bad rgbe scanline format");let ye=0,L;for(;ye<ie&&re<V.byteLength;){L=V[re++];const he=L>128;if(he&&(L-=128),(L===0||ye+L>ie)&&u(3,"bad scanline data"),he){const ge=V[re++];for(let Ae=0;Ae<L;Ae++)K[ye++]=ge}else K.set(V.subarray(re,re+L),ye),ye+=L,re+=L}const J=H;for(let he=0;he<J;he++){let ge=0;Y[ae]=K[he+ge],ge+=H,Y[ae+1]=K[he+ge],ge+=H,Y[ae+2]=K[he+ge],ge+=H,Y[ae+3]=K[he+ge],ae+=4}q--}return Y},M=function(V,C,w,H){const Y=V[C+3],ae=Math.pow(2,Y-128)/255;w[H+0]=V[C+0]*ae,w[H+1]=V[C+1]*ae,w[H+2]=V[C+2]*ae,w[H+3]=1},T=function(V,C,w,H){const Y=V[C+3],ae=Math.pow(2,Y-128)/255;w[H+0]=Kc.toHalfFloat(Math.min(V[C+0]*ae,65504)),w[H+1]=Kc.toHalfFloat(Math.min(V[C+1]*ae,65504)),w[H+2]=Kc.toHalfFloat(Math.min(V[C+2]*ae,65504)),w[H+3]=Kc.toHalfFloat(1)},S=new Uint8Array(e);S.pos=0;const y=v(S),N=y.width,U=y.height,D=x(S.subarray(S.pos),N,U);let O,z,B;switch(this.type){case ni:B=D.length/4;const V=new Float32Array(B*4);for(let w=0;w<B;w++)M(D,w*4,V,w*4);O=V,z=ni;break;case ba:B=D.length/4;const C=new Uint16Array(B*4);for(let w=0;w<B;w++)T(D,w*4,C,w*4);O=C,z=ba;break;default:throw new Error("THREE.HDRLoader: Unsupported type: "+this.type)}return{width:N,height:U,data:O,header:y.string,gamma:y.gamma,exposure:y.exposure,type:z}}setDataType(e){return this.type=e,this}load(e,n,a,r){function l(u,f){switch(u.type){case ni:case ba:u.colorSpace=Gn,u.minFilter=Rn,u.magFilter=Rn,u.generateMipmaps=!1,u.flipY=!0;break}n&&n(u,f)}return super.load(e,l,a,r)}}class Tp extends Gp{constructor(e){e={...{count:500,texturePaths:["/green_leaf.png"],particleSize:4,fallSpeed:{min:1,max:3},sway:{x:2,z:2},yPosition:{min:0,max:150}},...e};const a=new di,r=new Float32Array(e.count*3),l=new Float32Array(e.count*3),u=new Float32Array(e.count);for(let g=0;g<e.count;g++)r[g*3+0]=(Math.random()*2-1)*100,r[g*3+1]=e.yPosition.min+Math.random()*(e.yPosition.max-e.yPosition.min),r[g*3+2]=(Math.random()*2-1)*150,l[g*3+0]=Math.random()*Math.PI*2,l[g*3+1]=e.fallSpeed.min+Math.random()*(e.fallSpeed.max-e.fallSpeed.min),l[g*3+2]=Math.random(),u[g]=Math.floor(Math.random()*e.texturePaths.length);a.setAttribute("position",new vn(r,3)),a.setAttribute("aRandom",new vn(l,3)),a.setAttribute("aTextureIndex",new vn(u,1));const f=new zy,p=e.texturePaths.map(g=>f.load(g)),h=new Pi({defines:{TEXTURE_COUNT:p.length},uniforms:{uTime:{value:0},uTextures:{value:p},uParticleSize:{value:e.particleSize},uSway:{value:new at(e.sway.x,e.sway.z)}},vertexShader:`
        uniform float uTime;
